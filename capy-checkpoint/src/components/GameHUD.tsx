...
/**
 * Game HUD - displays lives, score, and coins
 * Positioned as overlay above Phaser canvas
 */
export function GameHUD() {
  ...
  return (
    <div className="absolute top-4 left-4 right-4 flex justify-between items-center z-10 pointer-events-none">
      ...
      {/* Score */}
      <div className="bg-white/80 px-4 py-2 rounded-full border-4 border-sky font-baloo text-2xl text-text">
        Score: {score}
      </div>

      {/* Coins */}
      <div className="bg-white/80 px-4 py-2 rounded-full border-4 border-yellow flex items-center gap-2 font-fredoka text-2xl text-text">
